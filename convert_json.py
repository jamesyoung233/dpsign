...
def getActivityInfo(token, venderId):
    ...
    try:
        ...
        data.append([token, venderId, activityId, typeId[0] if typeId else 2, stday, levels, startTime, endTime,
...
if __name__ == '__main__':
    ...
    with open('new.json', mode='w+', encoding='utf-8') as f:
        json.dump(js, f, ensure_ascii=False)
    print('店铺签到转换成功，请去脚本所在目录查看new.json')
